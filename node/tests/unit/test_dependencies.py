...
import api.depends.runtime as runtime_dependencies
...
def test_user_service_is_shared_between_requests(monkeypatch) -> None:
    ...
    monkeypatch.setattr(runtime_dependencies, "container_runtime", None)
...
def test_other_stateful_dependencies_are_shared(monkeypatch) -> None:
    ...
    getters = (
        ...
        runtime_dependencies.get_container_runtime,
